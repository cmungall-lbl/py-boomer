# Contributing to boomer-py

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
boomer-py. These guidelines are not strict rules.
...
The boomer-py team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the boomer-py technical leads
...
[issues]: https://github.com/monarch-initiative/boomer-py/issues/
[pulls]: https://github.com/monarch-initiative/boomer-py/pulls/
